...
proc create_root_design { parentCell } {
  ...
  # Create instance: Switch_Fabric, and set properties
  set Switch_Fabric [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 Switch_Fabric ]
  set_property -dict [ list \
   CONFIG.NUM_MI {7} \
 ] $Switch_Fabric
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_stream_txfifo_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_stream_txfifo_0_M00_AXIS [get_bd_intf_pins BiDirChannels_0/S00_AXIS] [get_bd_intf_pins axis_stream_txfifo_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_stream_txfifo_0_M01_AXIS [get_bd_intf_pins BiDirChannels_0/s01_axis] [get_bd_intf_pins axis_stream_txfifo_0/M01_AXIS]
  connect_bd_intf_net -intf_net axis_stream_txfifo_0_M02_AXIS [get_bd_intf_pins BiDirChannels_0/s02_axis] [get_bd_intf_pins axis_stream_txfifo_0/M02_AXIS]
