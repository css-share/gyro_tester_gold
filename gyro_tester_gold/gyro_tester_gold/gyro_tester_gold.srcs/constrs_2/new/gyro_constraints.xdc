...
set_property IOSTANDARD LVCMOS25 [get_ports DRX]
set_property IOSTANDARD LVCMOS25 [get_ports DTX]
set_property IOSTANDARD LVCMOS25 [get_ports DSYNC]
set_property IOSTANDARD LVCMOS25 [get_ports RXACTIVE]
set_property IOSTANDARD LVCMOS25 [get_ports SYNC_10MHz]
#
...
#
#set_property IOSTANDARD LVCMOS25 [get_ports SCAN_MODE]
#set_property IOSTANDARD LVCMOS25 [get_ports SCAN_SHIFT_EN]
#set_property IOSTANDARD LVCMOS25 [get_ports SCAN_CLK]
#set_property IOSTANDARD LVCMOS25 [get_ports SCAN_IN]
#set_property IOSTANDARD LVCMOS25 [get_ports SCAN_OUT]
#--------------------------------------
...
set_property PACKAGE_PIN A21 [get_ports SYNC_10MHz]
#
set_property PACKAGE_PIN A19 [get_ports SPI_DATA]
