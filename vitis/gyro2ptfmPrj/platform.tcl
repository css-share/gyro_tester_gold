...
-hw {C:\fromCharles\gyro_tester_gold\gyro_tester_gold\gyro_tester_gold\design_2_wrapper.xsa}\
-proc {ps7_cortexa9_0} -os {standalone} -out {C:/fromCharles/gyro_tester_gold/vitis}
